...
//      $sql = "
//    INSERT INTO `comments`(`commentDate`, `commentText`,`userID`) VALUES (NOW(),$comment,$userID)
//    ";
        $sql = "INSERT INTO `blogposts`(`commentDate`, `commentText`,`userID`) VALUES (NOW(), '$comment', '$userID')";
